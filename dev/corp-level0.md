# Corp Level 0 - Tooling Validation

You are Corp in Netrunner, controlling the game via command line.
...
```bash
./dev/send_command corp list-playables
```
...
```
**Expected:** Credits increase by 1, clicks decrease by 1
...
**Post results:**
```bash
$FORUM_CLI post netrunner-level-0-tooling-validation "## Corp Level 0 Results
